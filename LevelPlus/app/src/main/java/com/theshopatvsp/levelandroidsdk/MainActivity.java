...
public class MainActivity extends Activity {
    ...
    private static final int BLUETOOTH_EXTERNAL_PERMISSION = 1111;
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            connectHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    deviceClient.connect(null); //"091A"
                }
            }, 1000);
        }
        ...
        if (mBluetoothAdapter == null) {
            ...
            if (!mBluetoothAdapter.isEnabled()) {
                ...
                startActivityForResult(new Intent(
                        BluetoothAdapter.ACTION_REQUEST_ENABLE), BLUETOOTH_EXTERNAL_PERMISSION);
            }
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            ...
            case BLUETOOTH_EXTERNAL_PERMISSION:
